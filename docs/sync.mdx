...
* **Software Development Kit (SDK):** A pre-built software development kit (SDK) that enables developers to embed HRMS Sync into their existing platforms, offering more customization and control over the integration process.
...
### For Console Users:
* Test Environment: Access the HRMS Sync platform through a web-based console, where data retrieval is simulated for testing purposes.
