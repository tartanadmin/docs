...
description: 'Tartan offers multiple integration methods to help you establish seamless connections with your client organization. '
---
...
Your client admin selects the specific data points they wish to share with you across various data models, such as employee details, dependent information, salary data, bank details. 
 ...
 {/* <Step title="Client admin maps the Datapoints">
 If the Salary data model was enabled in the previous step, the client admin will need to map their salary data points to our JSON format.
  </Step> */}
...
<Step title="Client admin maps the column headers with Tartan keys">
 he client admin associates the CSV column headers with Tartan's corresponding keys<br></br>
</Step>
