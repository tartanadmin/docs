...
This event is triggered when client or corporate terminates the connection either from console or using the [terminate connection API](api-reference/sdk/get-sdk-token). 
