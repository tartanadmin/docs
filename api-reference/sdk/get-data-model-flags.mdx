...
This GET API fetches the global data selection model used to configure data_model_flags. It returns available fields and flags that can be used to customize data retrieval for client organizations.
